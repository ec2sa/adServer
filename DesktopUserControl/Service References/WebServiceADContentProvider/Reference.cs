...
namespace DesktopUserControl.WebServiceADContentProvider {
    ...
    public interface WebServiceADContentProviderSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string GetMultimediaObject(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetMultimediaObject", ReplyAction="*")]
        System.Threading.Tasks.Task<string> GetMultimediaObjectAsync(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/MultimediaObjectUrlClicked", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string MultimediaObjectUrlClicked(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request, int id, int statusCode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/MultimediaObjectUrlClicked", ReplyAction="*")]
        System.Threading.Tasks.Task<string> MultimediaObjectUrlClickedAsync(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request, int id, int statusCode);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WebServiceADContentProviderSoapChannel : DesktopUserControl.WebServiceADContentProvider.WebServiceADContentProviderSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WebServiceADContentProviderSoapClient : System.ServiceModel.ClientBase<DesktopUserControl.WebServiceADContentProvider.WebServiceADContentProviderSoap>, DesktopUserControl.WebServiceADContentProvider.WebServiceADContentProviderSoap {
        ...
        public string GetMultimediaObject(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request) {
            return base.Channel.GetMultimediaObject(request);
        }
        
        public System.Threading.Tasks.Task<string> GetMultimediaObjectAsync(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request) {
            return base.Channel.GetMultimediaObjectAsync(request);
        }
        
        public string MultimediaObjectUrlClicked(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request, int id, int statusCode) {
            return base.Channel.MultimediaObjectUrlClicked(request, id, statusCode);
        }
        
        public System.Threading.Tasks.Task<string> MultimediaObjectUrlClickedAsync(DesktopUserControl.WebServiceADContentProvider.GetMultimediaObject_Request request, int id, int statusCode) {
